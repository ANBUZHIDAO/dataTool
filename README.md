...
# dataTool简介
    ...
    前台管理界面使用VUE做数据绑定，框架界面使用的EasyUI模板修改的，简化了菜单项，匹配到最新的EasyUI版本。 
    各个菜单实际使用的是EasyUI Demo渲染后的界面抠出来的元素节点来做的。
    对比React,AngularJS来说，VUE比较轻量级。

    这是第二个版本。最大的变化是提供了前台界面，并使用多节点一起构造数据。
